...
(function () {
  ...
  332: [function (require, module, exports) {
    ...
    var json_api_1 = require("./helpers/json-api");
    ...
    window.app = app;
    window.JsonApi = json_api_1.JsonApi;
    loader_1.loadController(app, root_controller_1.RootController, 'RootController');
    loader_1.loadRoutes(app, routes_1.Routes);
  }, {
    "./controllers/root-controller": 339,
    "./helpers/json-api": 347,
    "./loader": 349,
    "./routes": 350,
    "babel-polyfill": 1
  }],
  ...
  334: [function (require, module, exports) {
    ...
    var api_1 = require("../../game/api");

    var level_1 = require("../../game/level");

    var LevelEditController = /*#__PURE__*/function () {
      function LevelEditController() {
        _classCallCheck(this, LevelEditController);

        this.inject = ['$scope', '$http', '$routeParams'];
      }

      _createClass(LevelEditController, [{
        key: "controller",
        value: function controller($scope, $http, $routeParams) {
          console.log('routeParams', $routeParams.id);
          $scope.fetchLevel = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
            var response;
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    _context.next = 3;
                    return api_1.api.get("levels/fetch/".concat($routeParams.id));
          ...
          $scope.addItem = function (clue) {
            clue.items.push(new level_1.ClueItem());
            $scope.currentItem = clue.items[clue.items.length - 1];
          };

          $scope.save = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    _context2.next = 4;
                    return api_1.api.post("levels/edit/".concat($scope.level.id), {
                      data: $scope.level
                    });
                  ...
                  case 8:
                    _context2.next = 10;
                    return api_1.api.post('levels/create', {
                      data: $scope.level
                    });
          ...
          var svg = $('#gp-image-wrapper svg');
          var image = $('#gp-image-wrapper img');
          var svgPath = $('#gp-image-wrapper svg path');
          image.on('load', function () {
            svg.width(image.width());
            svg.height(image.height());
            console.log(image.width());
          });
          $('#gp-image-wrapper svg').on('mousemove', function (event) {
            if (event.buttons !== undefined && event.buttons !== 1) {
              mouse.isDown = false;
            }

            if (mouse.isDown && $scope.currentItem) {
              var parentOffset = $('#gp-image-wrapper svg').parent().offset();
              var x = (event.pageX || event.originalEvent.touches[0].pageX) - parentOffset.left;
              var y = (event.pageY || event.originalEvent.touches[0].pageY) - parentOffset.top;
              $scope.currentItem.path.push({
                x: x,
                y: y
              });
          ...
          $('#gp-image-wrapper svg').on('mousedown', function (event) {
          ...
          $('#gp-image-wrapper svg').on('mouseup', function (event) {
            event.preventDefault();
          });
        }
      }]);

      return LevelEditController;
    }();
  ...
  335: [function (require, module, exports) {
    ...
    var LevelListController = /*#__PURE__*/function () {
      function LevelListController() {
        _classCallCheck(this, LevelListController);

        this.inject = ['$scope', '$http', '$routeParams'];
      }

      _createClass(LevelListController, [{
        key: "controller",
        value: function controller($scope, $http, $routeParams) {
          $scope.fetchLevels = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
            var response;
            return regeneratorRuntime.wrap(function _callee3$(_context3) {
              while (1) {
                switch (_context3.prev = _context3.next) {
                  case 0:
                    _context3.next = 2;
                    return api_1.api.get('levels/list');
  ...
  336: [function (require, module, exports) {
    ...
    var CreateGameController = /*#__PURE__*/function () {
      ...
      _createClass(CreateGameController, [{
        key: "controller",
        value: function controller($location, $scope) {
          ...
          $scope.createGame = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
            var game;
              ...
              while (1) {
                switch (_context4.prev = _context4.next) {
                  ...
                  case 2:
                    ...
                    _context4.prev = 3;
                    console.log("Creating game with room ".concat($scope.gameName));
                    _context4.next = 7;
                    return api_1.api.createGame($scope.gameName);
    ...
    var HomeController = /*#__PURE__*/function () {
      ...
      _createClass(HomeController, [{
        ...
        value: function controller($scope) {
          ...
          $scope.createPlayer = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
            var player;
              ...
              while (1) {
                switch (_context5.prev = _context5.next) {
                  ...
                  case 3:
                    ...
                    _context5.prev = 4;
                    _context5.next = 7;
                    return api_1.api.createPlayer($scope.player.attributes.name);
  ...
  338: [function (require, module, exports) {
    ...
    var JoinGameController = /*#__PURE__*/function () {
      function JoinGameController() {
        _classCallCheck(this, JoinGameController);

        this.inject = ['$location', '$scope'];
      }

      _createClass(JoinGameController, [{
        key: "controller",
        value: function controller($location, $scope) {
          if (!state_1.state.hasPlayer) {
            $location.path('/');
            ...
            return regeneratorRuntime.wrap(function _callee6$(_context6) {
              while (1) {
                switch (_context6.prev = _context6.next) {
                  case 0:
                    _context6.next = 2;
                    return api_1.api.getGames();

                  case 2:
                    $scope.games = _context6.sent.filter(function (game) {
          ...
          $scope.joinGame = /*#__PURE__*/function () {
            var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(game) {
              return regeneratorRuntime.wrap(function _callee7$(_context7) {
                while (1) {
                  switch (_context7.prev = _context7.next) {
                    case 0:
                      _context7.prev = 0;
                      console.log("Joining game ".concat(game.attributes.name));
                      $scope.isJoiningGame = true;
                      _context7.next = 5;
                      return api_1.api.joinGame(game);
  ...
  339: [function (require, module, exports) {
    ...
    var RootController = /*#__PURE__*/function () {
      function RootController() {
        ...
        this.inject = ['$rootScope', '$scope', '$http'];
      }

      _createClass(RootController, [{
        key: "controller",
        value: function controller($rootScope, $scope, $http) {
  ...
  340: [function (require, module, exports) {
    ...
    var RoundController = /*#__PURE__*/function () {
      function RoundController() {
        _classCallCheck(this, RoundController);
  ...
  341: [function (require, module, exports) {
    ...
    var SelectLevelController = /*#__PURE__*/function () {
      function SelectLevelController() {
        _classCallCheck(this, SelectLevelController);

        this.inject = ['$location', '$scope'];
      }

      _createClass(SelectLevelController, [{
        key: "controller",
        value: function controller($location, $scope) {
            ...
            return regeneratorRuntime.wrap(function _callee8$(_context8) {
              while (1) {
                switch (_context8.prev = _context8.next) {
                  case 0:
                    _context8.next = 2;
                    return api_1.api.getLevel('17c69238-fd2e-430d-afdf-0b38d8c3fd14');
  ...
  342: [function (require, module, exports) {
    ...
    var Api = /*#__PURE__*/function () {
      ...
      _createClass(Api, [{
        ...
        key: "post",
        value: function () {
          var _post = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(url, data) {
            var response;
            return regeneratorRuntime.wrap(function _callee9$(_context9) {
              while (1) {
                switch (_context9.prev = _context9.next) {
                  case 0:
                    _context9.next = 2;
                    return this.$http.post("".concat(this.apiBaseUrl, "/api/").concat(url), data);
        ...
        key: "get",
        value: function () {
          var _get = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(url) {
            var response;
            return regeneratorRuntime.wrap(function _callee10$(_context10) {
              while (1) {
                switch (_context10.prev = _context10.next) {
                  case 0:
                    _context10.next = 2;
                    return this.$http.get("".concat(this.apiBaseUrl, "/api/").concat(url));
        ...
        key: "createPlayer",
        value: function () {
          var _createPlayer = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11(name) {
            var response, player;
            return regeneratorRuntime.wrap(function _callee11$(_context11) {
              while (1) {
                switch (_context11.prev = _context11.next) {
                  case 0:
                    _context11.next = 2;
                    return this.post('players/create', {
                      data: {
                        attributes: {
                          name: name
                        }
                  ...
                  case 2:
                    ...
                    player = player_1.Player.mapModel(response);
                    console.log('Created player!', player);
                    return _context11.abrupt("return", player);
        ...
        key: "getGames",
        value: function () {
          var _getGames = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee12() {
            var response, games;
              ...
              while (1) {
                switch (_context12.prev = _context12.next) {
                  ...
                  case 2:
                    ...
                    games = game_1.Game.mapModels(response);
                    console.log('Fetched games!', games);
                    return _context12.abrupt("return", games);
        ...
        key: "getGame",
        value: function () {
          var _getGame = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee13(id) {
            var response, game;
            return regeneratorRuntime.wrap(function _callee13$(_context13) {
              while (1) {
                switch (_context13.prev = _context13.next) {
                  case 0:
                    _context13.next = 2;
                    return this.get("games/fetch/".concat(id));

                  case 2:
                    response = _context13.sent;
                    game = game_1.Game.mapModel(response);
                    console.log('Fetched game!', game);
                    return _context13.abrupt("return", game);
        ...
        key: "createGame",
        value: function () {
          var _createGame = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee14(name) {
            var response, game;
        ...
        key: "joinGame",
        value: function () {
          var _joinGame = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee15(game) {
        ...
        key: "getLevels",
        value: function () {
          var _getLevels = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee16() {
            var response, levels;
            return regeneratorRuntime.wrap(function _callee16$(_context16) {
              while (1) {
                switch (_context16.prev = _context16.next) {
                  case 0:
                    _context16.next = 2;
                    return this.get('levels/list');

                  case 2:
                    response = _context16.sent;
                    levels = level_1.Level.mapModels(response);
                    console.log('Fetched levels!', levels);
                    return _context16.abrupt("return", levels);
        ...
        key: "getLevel",
        value: function () {
          var _getLevel = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee17(id) {
            var response, level;
            return regeneratorRuntime.wrap(function _callee17$(_context17) {
              while (1) {
                switch (_context17.prev = _context17.next) {
                  case 0:
                    _context17.next = 2;
                    return this.get("levels/fetch/".concat(id));

                  case 2:
                    response = _context17.sent;
                    level = level_1.Level.mapModel(response);
                    console.log('Fetched level!', level);
                    return _context17.abrupt("return", level);
  ...
  343: [function (require, module, exports) {
    ...
    var model_1 = require("../helpers/json-api/model");
  ...
  344: [function (require, module, exports) {
    ...
    var ClueItem = function ClueItem() {
      _classCallCheck(this, ClueItem);
    ...
    var Level = /*#__PURE__*/function (_model_1$Model2) {
      _inherits(Level, _model_1$Model2);

      var _super2 = _createSuper(Level);
      ...
      function Level(args) {
        ...
        _this2.attributes.clues = _this2.attributes.clues || [];
        return _this2;
      }

      _createClass(Level, [{
        key: "getPathString",
        value: function getPathString(item) {
          var d = [];

          var _iterator = _createForOfIteratorHelper(item.path),
              _step;
          ...
          try {
            for (_iterator.s(); !(_step = _iterator.n()).done;) {
              ...
              if (d.length === 0) {
                d.push("M ".concat(p.x, ", ").concat(p.y));
              } else {
                d.push("L ".concat(p.x, ", ").concat(p.y));
              }
            }
          } catch (err) {
            _iterator.e(err);
  ...
  345: [function (require, module, exports) {
    ...
    var Player = /*#__PURE__*/function (_model_1$Model3) {
      _inherits(Player, _model_1$Model3);
    ...
    var State = /*#__PURE__*/function () {
      ...
      _createClass(State, [{
        ...
        value: function startGame() {
          ...
          console.log("Starting game: ".concat(this.game.attributes.name, "!"));
        }
      }, {
        key: "validateGame",
        value: function validateGame() {
          if (!this.player) {
  ...
  347: [function (require, module, exports) {
    ...
    var JsonApi = /*#__PURE__*/function () {
      ...
      _createClass(JsonApi, null, [{
        key: "parseEntity",
        value: function parseEntity(entity, included) {
          var _this3 = this;
          ...
          var _loop = function _loop(_key) {
            if (Array.isArray(entity.relationships[_key].data)) {
              result[_key] = entity.relationships[_key].data.map(function (r) {
                return _this3.parseEntity(included.find(function (i) {
                  return i.id === r.id && i.type === r.type;
                }), included);
              });
            } else {
              result[_key] = _this3.parseEntity(included.find(function (i) {
                return i.id === entity.relationships[_key].data.id && i.type === entity.relationships[_key].data.type;
              }), included);
            }
          };

          for (var _key in entity.relationships) {
            _loop(_key);
          }
        ...
        key: "parseSingle",
        value: function parseSingle(jsonApiStructure) {
          return this.parseEntity(jsonApiStructure.data, jsonApiStructure.included);
        }
      }, {
        key: "parseMultiple",
        value: function parseMultiple(jsonApiStructure) {
          var result = [];

          var _iterator2 = _createForOfIteratorHelper(jsonApiStructure.data),
              _step2;
  ...
  348: [function (require, module, exports) {
    ...
    var Model = /*#__PURE__*/function () {
      ...
      _createClass(Model, [{
        ...
        value: /*#__PURE__*/regeneratorRuntime.mark(function parseRelationships(cache) {
          return regeneratorRuntime.wrap(function parseRelationships$(_context18) {
            while (1) {
        ...
        key: "findRelated",
        value: function findRelated(relationshipNames, ImplementedModel, cache) {
          var _this4 = this;
          ...
          var _iterator3 = _createForOfIteratorHelper(relationshipNames),
              _step3;

          try {
            var _loop2 = function _loop2() {
              var _this4$relationships$;

              var relationshipName = _step3.value;

              if (!_this4.included || !_this4.relationships[relationshipName] || !_this4.relationships[relationshipName].data) {
                return "continue";
              }

              var relationshipData = (_this4$relationships$ = _this4.relationships[relationshipName]) === null || _this4$relationships$ === void 0 ? void 0 : _this4$relationships$.data;

              if (!(relationshipData !== null && relationshipData !== void 0 && relationshipData.id)) {
                return "continue";
              }

              var relatedModel = _this4.included.find(function (included) {
              ...
              if (cache["".concat(relatedModel.type, ":").concat(relatedModel.id)]) {
                return {
                  v: cache["".concat(relatedModel.type, ":").concat(relatedModel.id)]
                };
              }

              return {
                v: new ImplementedModel({
                  id: relatedModel.id,
                  type: relatedModel.type,
                  attributes: relatedModel.attributes,
                  relationships: relatedModel.relationships,
                  included: _this4.included,
                  meta: _this4.meta
                })
              };
            };
        ...
        key: "findAllRelated",
        value: function findAllRelated(relationshipNames, ImplementedModel, cache) {
          var _this5 = this;
          ...
          var _iterator4 = _createForOfIteratorHelper(relationshipNames),
              _step4;

          try {
            var _loop3 = function _loop3() {
              var _this5$relationships$;

              var relationshipName = _step4.value;

              if (!_this5.relationships[relationshipName]) {
                return "continue";
              }

              var relationshipData = (_this5$relationships$ = _this5.relationships[relationshipName]) === null || _this5$relationships$ === void 0 ? void 0 : _this5$relationships$.data;

              if (!(relationshipData !== null && relationshipData !== void 0 && relationshipData.length)) {
                return "continue";
              }

              var relatedIds = relationshipData.map(function (r) {
                return r.id.toString();
              });
              return {
                v: _this5.included.filter(function (included) {
                  return ImplementedModel.isType(included.type.toLowerCase()) && relatedIds.indexOf(included.id.toString()) >= 0;
                }).map(function (data) {
                  if (cache["".concat(data.type, ":").concat(data.id)]) {
                    return cache["".concat(data.type, ":").concat(data.id)];
                  }
        ...
        key: "fromJsonApi",
        value: function fromJsonApi(jsonApiModel, jsonApiData) {
          return new this({
            id: jsonApiModel.id,
        ...
        key: "mapModel",
        value: function mapModel(response) {
        ...
        key: "mapModels",
        value: function mapModels(response) {
        ...
        key: "checkResponse",
        value: function checkResponse(response, expectsMultiple) {
          if (!response) {
        ...
        key: "processRelationships",
        value: function processRelationships(pendingRelationshipParse) {
          var cache = {};

          while (pendingRelationshipParse.length > 0) {
            var next = pendingRelationshipParse.pop();
            ...
            cache["".concat(next.type, ":").concat(next.id)] = next;

            var _iterator6 = _createForOfIteratorHelper(next.parseRelationships(cache)),
                _step6;

            try {
              for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {
                var relationships = _step6.value;

                if (!relationships) {
                  continue;
                } else if (Array.isArray(relationships)) {
                  var _iterator7 = _createForOfIteratorHelper(relationships),
                      _step7;

                  try {
                    for (_iterator7.s(); !(_step7 = _iterator7.n()).done;) {
                      var relationship = _step7.value;
                      cache["".concat(relationship.type, ":").concat(relationship.id)] = relationship;
                  ...
                  cache["".concat(relationships.type, ":").concat(relationships.id)] = relationships;
  ...
  349: [function (require, module, exports) {
    ...
    function loadDirective(app, directiveClass, name) {
      var instance = new directiveClass();
      app.directive(name, [].concat(_toConsumableArray(instance.inject), [function () {
        return {
          ...
          link: instance.directive.apply(instance, arguments)
        };
      }]));
    }
    ...
    function loadController(app, controllerClass, name) {
      ...
      app.controller(name, [].concat(_toConsumableArray(instance.inject), [instance.controller]));
    }

    exports.loadController = loadController;

    function loadFactory(app, factoryClass, name) {
      var instance = new factoryClass();
      app.factory(name, [].concat(_toConsumableArray(instance.inject), [instance.factory]));
    }

    exports.loadFactory = loadFactory;

    function loadFilter(app, filterClass, name) {
      var instance = new filterClass();
      app.filter(name, [].concat(_toConsumableArray(instance.inject), [instance.filter]));
    }
  ...
  350: [function (require, module, exports) {
    ...
    var create_game_controller_1 = require("./controllers/create-game-controller");

    var home_controller_1 = require("./controllers/home-controller");

    var join_game_controller_1 = require("./controllers/join-game-controller");

    var level_list_controller_1 = require("./controllers/admin/level-list-controller");

    var level_edit_controller_1 = require("./controllers/admin/level-edit-controller");

    var round_controller_1 = require("./controllers/round-controller");

    var select_level_controller_1 = require("./controllers/select-level-controller");
    ...
    "./controllers/admin/admin-controller": 333,
    "./controllers/admin/level-edit-controller": 334,
    "./controllers/admin/level-list-controller": 335,
    "./controllers/create-game-controller": 336,
    "./controllers/home-controller": 337,
    "./controllers/join-game-controller": 338,
    "./controllers/round-controller": 340,
    "./controllers/select-level-controller": 341
  }]
}, {}, [332]);